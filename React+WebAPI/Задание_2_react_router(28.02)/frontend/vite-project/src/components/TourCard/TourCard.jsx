      ...
      <div className="card-image" style={{ position: 'relative', overflow: 'hidden', width: '230px', height: '312px', flexShrink: 0 }}>
        ...
        <button 
          ...
          style={{
            ...
            left: '8px',
            background: 'white',
            borderRadius: '50%',width: '32px',height: '32px',display: 'flex',alignItems: 'center',justifyContent: 'center',cursor: 'pointer',border: 'none',
      ...
      <div className="card-info" style={{ flex: 1, padding: '16px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <button 
            ...
            style={{
              background: '#ffe135',
              color: '#333',border: 'none',padding: '10px 24px',borderRadius: '8px',fontWeight: 'bold',fontSize: '16px',cursor: 'pointer',
              minWidth: '140px',
